...
class BoardTestCase(unittest.TestCase):
    ...
    def test_usi_command(self):
        ...
        board.push_usi_position_cmd(
            "position sfen ln1g3+Rl/1ks4s1/pp1gppbpp/2p3N2/9/5P1P1/PPPP1S1bP/2K1R1G2/LNSG3NL w 4p 42"
        )
        move = shogi.Move.from_usi("2g5d+")
        self.assertTrue(move in board.legal_moves)
        board.push_usi_position_cmd(
            "position sfen ln1g3+Rl/1ks4s1/pp1gppbpp/2p3N2/9/5P1P1/PPPP1S1bP/2K1R1G2/LNSG3NL w 4p 42 moves 2g5d+"
        )
